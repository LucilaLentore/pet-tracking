const PetDetail = () => {
  return(
    <div className="m-3 bg-white shadow-md px-5 py-10 rounded-xl">
      ...
      <p className="font-bold mb-3 text-gray-700 uppercase">Propietario: {""} <span className="font-normal normal-case">""</span></p>
      ...
      <p className="font-bold mb-3 text-gray-700 uppercase">Síntomas: {""} <span className="font-normal normal-case">""</span></p>
    </div>
  );
};
